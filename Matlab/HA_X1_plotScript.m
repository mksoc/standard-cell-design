...
zlabel('Normalized CO 70%-30% falling time')
...
xlabel('Input transition time [ps]')
ylabel('Load Capacitance [fF]')
zlabel('Normalized S 70%-30% falling time')
set(gca, 'View', [140 18], 'ZLim', [0.9 1.7])
...
xlabel('Input transition time [ps]')
ylabel('Load Capacitance [fF]')
zlabel('Normalized CO falling 50%-50% propagation delay')
set(gca, 'View', [140 18], 'ZLim', [0.9 1.7])
...
xlabel('Input transition time [ps]')
ylabel('Load Capacitance [fF]')
zlabel('Normalized S falling 50%-50% propagation delay')
set(gca, 'View', [140 18], 'ZLim', [0.9 1.7])
